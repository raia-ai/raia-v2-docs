...
**Goal:** Connect Wistia to the AI Agent to sync video transcripts for automated workflows and to provide the agent with up-to-date knowledge from your video content.**Who's Involved:**

* n8n Workflow Developer (Primary)
* RAIA Agent Engineer (Support)

See our native n8n integration at [https://n8n.io/integrations/wistia/](https://n8n.io/integrations/wistia/)
...
* [ ] Generate a Wistia API password.
* [ ] Identify the specific project containing the videos to be synced.
...
#### **Step 2: Extract & Transform Wistia Data**
...
* [ ] Configure the `Wistia - Transcripts -> raia` workflow to fetch video transcripts from the specified project.
...
* [ ] Configure the `Wistia - Transcripts -> raia` workflow to orchestrate the complete ETL process.
